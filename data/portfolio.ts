...
export const profile = {
  ...
  email: 'abhisharma72210@gmail.com',
  whatsapp: '+91-9664338196',
  whatsappLink: 'https://wa.me/919664338196',
  ...
  socials: {
    ...
    whatsapp: 'https://wa.me/919664338196',
...
const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    short:
      'Event landing page and registration funnel for a high-ticket immersion experience.',
    link: 'https://breakthroughweekend.in/immersion/',
    accent: 'from-pink-500 via-rose-400 to-amber-300',
    builder: 'Elementor',
    overview:
      'A conversion-focused event funnel for a multi-day immersion experience — built around a clear narrative, a registration flow and CRM-driven follow-up automations.',
  },
  {
  ...
  },
  {
    ...
    short:
      'Author and coach brand site featuring books, podcast, speaking and signature programs.',
    link: 'https://neetabhushan.com/',
    accent: 'from-rose-500 via-pink-500 to-fuchsia-500',
    builder: 'Elementor',
    overview:
      'A premium personal brand site spanning books, podcast, speaking engagements and signature programs — all with a consistent editorial-grade aesthetic.',
  },
  {
    slug: 'tegenoto',
    ...
    short:
      'Custom landing experience for a trust/identity product within the Share One ecosystem.',
    link: 'https://trust.share.one/tegenoto',
    accent: 'from-blue-500 via-indigo-500 to-violet-500',
    builder: 'Custom WP',
    overview:
      'A focused product landing for a trust/identity offering — clear value proposition, structured benefits and tight integration with the parent platform.',
  },
  {
  ...
  },
  {
    ...
    short:
      'Marketing site for an enterprise referral hiring SaaS, built around product education and demo capture.',
    link: 'https://www.ripplehire.com/',
    accent: 'from-blue-500 via-cyan-500 to-teal-400',
    builder: 'Elementor',
    overview:
      'Enterprise SaaS marketing site for a referral hiring product. Modular content blocks for product, customers, resources and demo requests.',
  },
  {
    slug: 'satori-method',
    title: 'Satori Method',
  ...
  },
  {
    ...
    short:
      'Personal coaching brand site with program landing pages and a booking-ready funnel.',
    link: 'https://coachingwithsid.com/',
    accent: 'from-indigo-500 via-violet-500 to-purple-500',
    builder: 'Elementor',
    overview:
      'A personal coaching brand site with program landing pages, testimonials and a CRM-integrated booking funnel.',
  },
  {
    slug: 'naya-life',
    title: 'Naya Life',
...
export const projects: Project[] = SEEDS.map((s) => ({
  ...
  cover: s.slug,
  accent: s.accent,
  technologies: ['WordPress', s.builder, 'ACF', 'Bootstrap', 'JavaScript'],
  overview: s.overview,
