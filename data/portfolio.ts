...
const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    builder: 'Custom Code',
    tech: ['Custom Code', 'HTML / CSS', 'JavaScript', 'Claude AI'],
    overview:
  ...
  },
  {
    ...
    builder: 'Showit',
    tech: ['Showit', 'Custom CSS', 'JavaScript'],
    overview:
  ...
  },
  {
    ...
    builder: 'GoHighLevel',
    tech: ['GoHighLevel', 'Custom HTML', 'CSS', 'JavaScript'],
    overview:
  ...
  },
  {
    ...
    builder: 'HubSpot',
    tech: ['HubSpot CMS', 'HubL', 'JavaScript', 'CSS'],
    overview:
...
export const projects: Project[] = SEEDS.map((s) => ({
  ...
  cover: s.slug,
  accent: s.accent,
  technologies: s.tech ?? ['WordPress', s.builder, 'ACF', 'Bootstrap', 'JavaScript'],
  overview: s.overview,
