...
function Counter({ value, suffix }: { value: number; suffix?: string }) {
  ...
  return (
    <span ref={ref} className="font-display font-semibold text-4xl sm:text-5xl text-fg">
      {count}
      {suffix}
    </span>
  );
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          >
            <p className="text-fg-muted text-base sm:text-lg leading-relaxed">
              Strong expertise in <span className="text-fg">HTML, CSS, JavaScript,
              ...
              builder ecosystem -{' '}
              <span className="text-fg">Elementor, Divi, Thrive, Beaver Builder,
              Oxygen and WPBakery</span> - as well as custom development using ACF and
              Custom Post Types.
            </p>
            <p className="mt-5 text-fg-muted text-base leading-relaxed">
              ...
              <span className="text-fg">Epic Businesses</span>, building scalable
          ...
          >
            {stats.map((s, i) => (
              ...
              >
                ...
                <span className="text-fg-subtle text-sm">{s.label}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
