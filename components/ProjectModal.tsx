          ...
          >
            <div className="sticky top-0 z-30 flex justify-end pt-4 pr-4 pointer-events-none">
              <button
                ...
                aria-label="Close"
                onClick={onClose}
                className="pointer-events-auto inline-flex items-center justify-center w-10 h-10 rounded-full border border-white/10 bg-ink-900/90 text-white hover:bg-white/15 transition shadow-lg backdrop-blur-md"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
