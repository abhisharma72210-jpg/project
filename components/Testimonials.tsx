    ...
    <section id="testimonials" className="relative">
      ...
      <div className="section">
        ...
        >
          ...
          <div
            className="relative mx-auto h-[500px] sm:h-[480px] overflow-hidden flex items-center justify-center"
...
function Card({ t, active }: { t: Testimonial; active: boolean }) {
  return (
    ...
    >
      ...
      <Quote aria-hidden className="absolute top-5 left-5 w-6 h-6 text-white/15" />
      ...
      <Quote aria-hidden className="absolute bottom-24 right-5 w-6 h-6 text-white/15 rotate-180" />
