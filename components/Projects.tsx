          ...
          <AnimatePresence mode="popLayout">
            {visibleProjects.map((p, i) => (
              <motion.button
                ...
                whileHover={{ y: -6 }}
                className="group text-left relative glass overflow-hidden flex flex-col h-full"
              >
                <div className="relative aspect-[16/9] overflow-hidden rounded-t-2xl shrink-0">
                  <ProjectArtwork
                    title={p.title}
                    accent={p.accent}
                    category={p.category}
