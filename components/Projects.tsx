                ...
                >
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="inline-flex items-center px-3 py-1 text-[11px] rounded-full border border-theme-strong text-fg-muted">
                        {category}
                      </span>
                      <span
                    ...
                    {/* Title */}
                    <h3 className="mt-4 font-display font-semibold text-fg text-xl leading-snug">
                      {p.title}
                    </h3>

                    {/* Description */}
                    <p className="mt-2 text-fg-subtle text-sm leading-relaxed line-clamp-2">
                      {p.shortDescription}
                    </p>
                    ...
                    >
                      <span className="relative w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-theme bg-glass text-fg font-medium text-sm overflow-hidden transition hover:border-theme-strong hover:bg-glass-strong">
                        <span
                          aria-hidden
