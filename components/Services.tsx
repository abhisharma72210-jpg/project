    ...
    >
      ...
      <div className="relative flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-6 flex items-center justify-between">
          <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] text-fg-fainter font-medium">
            <span
              aria-hidden
          ...
          <span
            aria-hidden
            className="inline-flex items-center justify-center w-8 h-8 rounded-full border border-theme bg-glass text-fg-subtle group-hover:bg-glass-strong group-hover:text-fg group-hover:translate-x-1 group-hover:-translate-y-0.5 transition-all duration-300"
          >
