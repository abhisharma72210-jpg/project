    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(255,255,255,0.05) 0%, transparent 25%, transparent 70%, rgba(0,0,0,0.35) 100%)',
          }}
        />
      </div>
    );
    ...
    >
      ...
      <div className="relative z-10 p-4 sm:p-6 h-full flex flex-col">
        <div className="flex items-center gap-1.5">
          ...
          <div className="ml-3 h-5 flex-1 rounded-md bg-white/10 backdrop-blur-sm border border-white/10" />
        </div>

        <div className="mt-4 flex-1 grid grid-cols-12 grid-rows-6 gap-2">
          {/* Hero block */}
          <div className="col-span-7 row-span-3 rounded-xl bg-black/20 backdrop-blur-md border border-white/15 p-3 flex flex-col justify-between">
          ...
          {/* Side card */}
          <div className="col-span-5 row-span-3 rounded-xl bg-white/15 backdrop-blur-md border border-white/20 p-3 flex flex-col gap-1.5">
          ...
          {[0, 1, 2, 3].map((i) => {
            ...
            return (
              <div
                key={i}
                className={`col-span-3 row-span-3 rounded-xl border border-white/15 p-2 flex flex-col gap-1.5 ${
                  variant === 0
        ...
        {!compact && (
          <div className="mt-3 flex items-center justify-between text-[10px] uppercase tracking-[0.18em] text-white/80">
