    ...
    <section id="experience" className="relative">
      ...
      <div className="section">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div
            aria-hidden
            className="absolute left-5 sm:left-1/2 top-0 bottom-0 -translate-x-1/2 w-px bg-gradient-to-b from-transparent via-slate-900/20 dark:via-white/15 to-transparent"
          />
